/* nearly a carbon copy of playfromyoutube.js, with some changes made almost
exclusively for torturing Brady.
                            ...
                            if (link.includes('https://www.youtube.com/watch?v=') || link.includes('https://youtu.be/')) {
                                ...
                                if (link.includes('https://www.youtube.com/watch?v=')) {
                                    ...
                                    if (globalPlaying === true) {
                                        ...
                                        try {
                                        const hahaFuckUBrady = client.channels.cache.get('769677782312812565')
                                        const connection = await hahaFuckUBrady.join();
